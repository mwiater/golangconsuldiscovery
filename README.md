...
This repository is a code companion to my article on Better Programming: **[Replicating and Load Balancing Go Applications in Docker Containers with Consul and Fabio](https://betterprogramming.pub/replicating-and-load-balancing-go-applications-in-docker-containers-with-consul-and-fabio-3ec5eed15154)**. Please see that post for more details on this implementation.
